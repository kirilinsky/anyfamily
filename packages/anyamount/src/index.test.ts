...
import { anyamount, anyamountParts } from "./index";
...
describe("currency mode", () => {
  ...
  it("ignores unit-mode options", () => {
    expect(
      anyamount(5, { mode: "currency", currency: "USD", unit: "gigabyte", locale: "en" }),
    ).toBe(anyamount(5, { mode: "currency", currency: "USD", locale: "en" }));
  });
});
...
describe("unit mode", () => {
  ...
  it("ignores currency-mode options", () => {
    expect(
      anyamount(5, { mode: "unit", unit: "meter", currency: "EUR", locale: "en" }),
    ).toBe(anyamount(5, { mode: "unit", unit: "meter", locale: "en" }));
  });
});
