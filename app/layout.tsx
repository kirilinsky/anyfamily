...
export const metadata: Metadata = {
  ...
  description:
    "The any* family: eight micro, zero-dependency JavaScript tools built on native Intl. Names & flags, money, dates, durations, lists, plurals, words, and locale behaviour — in any locale.",
  keywords: [
    "intl",
    "i18n",
    "l10n",
  ...
  openGraph: {
    ...
    description:
      "Eight micro, zero-dependency tools on native Intl: names & flags, money, dates, durations, lists, plurals, words, locale behaviour. Any locale.",
    siteName: "anyfamily",
    locale: "en_US",
  },
  twitter: {
    ...
    title: "anyfamily — micro Intl tools for any locale",
    description: "Eight micro Intl tools. Zero data. Any locale.",
  },
