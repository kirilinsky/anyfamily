    ...
    <>
      <div className="relative w-fit max-w-full rounded-xl border border-white/[0.07] bg-black/30 px-4 py-3.5 font-mono">
        <div className="flex min-h-9 flex-wrap items-center justify-center gap-x-1 gap-y-1.5 text-sm sm:flex-nowrap sm:justify-start sm:text-base">
          <span className="shrink-0 text-accent">anylong</span>
          <span className="shrink-0 text-white/30">(</span>
          <span className="flex h-8 min-w-0 shrink items-center rounded-md border border-transparent px-1.5 text-sky-300 transition-colors hover:border-white/10 hover:bg-white/[0.05] focus-within:border-white/10 focus-within:bg-white/[0.05]">
      ...
      <div className="flex min-h-28 w-full flex-col items-center justify-center gap-3">
        ...
        {error && (
          <p className="font-sans text-[11px] text-white/25 italic">
        ...
        {parts && (
          ...
          >
            ...
            {parts.map((p, i) => (
              ...
              >
                <span className="text-white/65">{q(p.value)}</span>
